...
namespace Hammer
{
    ...
    public class SpinAroundConfigurableJoint : MonoBehaviour
    {
        ...
        // How fast can we "swing" it towards front
        public float SwingStrength;

        void Awake()
        {
            this.joint = this.hammer.GetComponent<ConfigurableJoint>();
        ...
        void Update()
        {
            ...
            {
                drive.positionSpring = this.SwingStrength;
            }
